...
namespace AutoAccelerator.AppPackage
{
    /// <summary>
    ...
    public class PackageTemplate : ImportExtension
    {
        ...
        {
            return "Microsoft Dynamics 365 Auto Accelerator App Add-On";
        }
        ...
        {
            get { return "Microsoft Dynamics 365 Auto Accelerator App Add-On"; }
        }
