...
namespace AutoAccelerator.CompletePackage
{
    /// <summary>
    ...
    public class PackageTemplate : ImportExtension
    {
        ...
        {
            return "Microsoft Dynamics 365 Auto Accelerator Complete";
        }
        ...
        {
            get { return "Microsoft Dynamics 365 Auto Accelerator Complete"; }
        }
